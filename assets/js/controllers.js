            ...
            if (chart_type == "pie_chart") {
                ...
                if (chart_type == "column_chart") {
                    ...
                    function drawChart() {
                        ...
                        // Instantiate and draw the chart.
                        var chart = new google.visualization.ColumnChart(document.getElementById('chart-display'));
                        chart.draw(data, options);
                    }
                }
                ...
                if (chart_type == "scatter_chart") {
                    ...
                    function drawChart() {
                        ...
                        // Instantiate and draw the chart.
                        var chart = new google.visualization.ScatterChart(document.getElementById('chart-display'));
                        chart.draw(data, options);
                    }
                }
                ...
                if (chart_type == "bar_chart") {
                    ...
                    function drawChart() {
                        ...
                        // Instantiate and draw the chart.
                        var chart = new google.visualization.BarChart(document.getElementById('chart-display'));
                        chart.draw(data, options);
                    }
                }

                // Combo chart
                if (chart_type == "combo_chart") {
                    google.charts.load('current', {
                        'packages': ['corechart']
                    });
                    ...
                    function drawChart() {
                        ...
                        // Instantiate and draw the chart.
                        var chart = new google.visualization.ComboChart(document.getElementById('chart-display'));
                        chart.draw(data, options);
                    }
                }
                ...
                if (chart_type == "area_chart") {
                    ...
                    function drawChart() {
                        ...
                        // Instantiate and draw the chart.
                        var chart = new google.visualization.AreaChart(document.getElementById('chart-display'));
                        chart.draw(data, options);
                    }
                }

                // Stepped Area chart
                if (chart_type == "stepped_area_chart") {
                    google.charts.load('current', {
                        'packages': ['corechart']
                    });
                    ...
                    function drawChart() {
                        ...
                        // Instantiate and draw the chart.
                        var chart = new google.visualization.SteppedAreaChart(document.getElementById('chart-display'));
                        chart.draw(data, options);
                    }
                }
